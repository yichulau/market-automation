...
const AdminSidebar = ({toggle} : ToggleMobile) => {
  
  
  return (
    <>
    {toggle && 
        <aside id="sidebar" className=" z-20 h-full top-0 left-0 flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75" aria-label="Sidebar">
                      ...
                      <li>
                          <Link href="/workflow/schedule">
                            <a className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                              ...
                              <span className="ml-3 flex-1 whitespace-nowrap">Schedule</span>
