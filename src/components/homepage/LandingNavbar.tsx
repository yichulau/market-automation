   ...
   <>
      ...
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        <a href="https://flowbite.com/" className="flex items-center">
            ...
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Social Marketer</span>
        </a>
        ...
        <div className="hidden w-full md:block md:w-auto justify-center items-center" id="navbar-default">
